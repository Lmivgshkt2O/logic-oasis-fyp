...
| Gate | Command | Result |
|---|---|---|
| Seed pedagogy + content approval | `firebase emulators:exec "npm test"` (firebase_seed) | PASS - 65 source-grounded questions (Year 4/5/6), rules deny answer keys/manifest |
| Seed CLI | `node firebase_seed/validate_question_banks.js` | PASS - 130 approved entries across 6 materials (Year 4/5/6) |
